...
<?php
    ...
    $sqlInsert = "UPDATE restman
                  SET goal3_data = '$goal3_data',
                      goal4_data = '$goal4_data',
                      salt2 = '$salt2'    
                  WHERE ID = (SELECT ID FROM restman WHERE name_data = '$name_data' ORDER BY CreateTime DESC LIMIT 1);";
